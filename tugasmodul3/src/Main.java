...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        bookList.add(1, new Book("889", "chatgpt ajah", 30, "sasuke"));
        bookList.add(2, new Book("765", "codingan error", 8, "Hinata"));
    ...
    public static class Student extends User {
        ...
        public Student(String nim, String name, String faculty, String studyProgram, ArrayList<Book> borrowedBooks) {
            super(nim);
            this.name = name;
